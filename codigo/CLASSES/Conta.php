...
class Conta
{
    ...
    public function inserir()
    {
        try {
            ...
            if (isset($_POST["nome"])) {
                ...
                $this->CATEGORIAS_CODIGO =  $_POST["categoria"];
                ...
                $sql = $con->prepare("insert into contas(nome,tipo, categorias_codigo, usuarios_codigo)
                                                values(?,?, ?, ?);");
                //EXECUTAR O COMANDO NO BANCO DE DADOS
                $sql->execute(array(
                    $this->NOME,
                    $this->TIPO,
                    $this->CATEGORIAS_CODIGO,
    ...
    public function listarTodos()
    {
        try {
            ...
            $sql = $con->prepare("select co.CODIGO, co.NOME, co.TIPO, ca.NOME as CATEGORIA from contas co JOIN categorias ca ON ca.CODIGO = co.CATEGORIAS_CODIGO; where ca.USUARIOS_CODIGO = ?");
    ...
    public function  alterar(){
        try{
            ...
            if(isset($_POST["Alterar"])) {
                ...
                $sql= $con->prepare("update  CONTAS set  NOME = ?, TIPO = ?, CATEGORIAS_CODIGO = ? WHERE CODIGO = ?");
